...
def makeGenerator():
    return ImageDataGenerator(zca_whitening=True, samplewise_center=True, featurewise_center = True, featurewise_std_normalization=True, validation_split = .33)
...
for train_index, test_index in sss:
    ...
    for i in range(acquisition_iterations):
        ...
        #predict 
        y_predicted = model.predict(X_Test, batch_size)
        y_reverted = np.argmax(Y_Test, axis=1)
